...
export const getAuthSettings = (): UserManagerSettings => ({
  ...
  response_type: 'code',
  scope: 'openid profile email offline_access postgrest_claims',

  // PKCE Settings
  code_challenge_method: 'S256',
  code_challenge: undefined, // Will be generated dynamically
  code_verifier: undefined, // Will be generated dynamically
